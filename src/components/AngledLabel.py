...
class AngledLabel(QWidget):
    ...
    def render(self) -> None:
        ...
        # Stylings
        label.setStyleSheet("padding: 40px; background-color: #D8DEE9; border-radius: 10px")
        ...
        # Stylings
        self.graphicsview.setStyleSheet("background-color: transparent; border-radius: 10px")
        
        # Set the values of the scollbar at a certain position, so that the widget is kept hidden unless the user hovers it
        QTimer.singleShot(0 , lambda : self.graphicsview.verticalScrollBar().setValue(self.graphicsview.verticalScrollBar().maximum()))

        QTimer.singleShot(0 , lambda : self.graphicsview.horizontalScrollBar().setValue(self.graphicsview.horizontalScrollBar().maximum()))
    ...
    def moveScrolls(self , event: QEnterEvent) -> None:
        ...
        animationMoving = QPropertyAnimation(self.graphicsview.verticalScrollBar() , b"value")
